import"./modulepreload-polyfill-B5Qt9EMX.js";import"./components-YsRQu0Q4.js";import{l as u}from"./favoritesService-Dfn4QY0M.js";import{a as m}from"./firebaseConfig-DA3vMik7.js";import"./vendor-DAUOFwH1.js";document.addEventListener("DOMContentLoaded",function(){f()});function i(a){const e={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return a?a.replace(/[&<>"']/g,o=>e[o]):""}async function f(){var o;const a=document.getElementById("favoriteRoutes"),e=document.getElementById("favoritesLoading");e&&(e.style.display="flex");try{await new Promise(t=>setTimeout(t,300));const s=(o=m.currentUser)==null?void 0:o.uid;if(!s){e&&(e.style.display="none"),a.innerHTML=`
