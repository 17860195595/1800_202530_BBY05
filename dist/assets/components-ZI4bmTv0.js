...
const g="modulepreload",f=function(i){return"/"+i},p={},d=function(e,t,n){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));s=Promise.allSettled(t.map(c=>{if(c=f(c),c in p)return;p[c]=!0;const h=c.endsWith(".css"),m=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const l=document.createElement("link");if(l.rel=h?"stylesheet":g,h||(l.as="script"),l.crossOrigin="",l.href=c,r&&l.setAttribute("nonce",r),document.head.appendChild(l),h)return new Promise((A,v)=>{l.addEventListener("load",A),l.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return s.then(a=>{for(const r of a||[])r.status==="rejected"&&o(r.reason);return e().catch(o)})},w="data:image/png;base64,",y="data:image/png;base64,";class k extends HTMLElement{constructor(){super()}getImagePath(e){return e==="ClearWay_logo.png"?w:e==="menuBtn.png"?y:document.querySelector('script[src*="assets/"]')||document.querySelector('link[href*="assets/"]')?`/assets/${e}`:`/src/assets/images/${e}`}getComponentsPath(e){if(document.querySelector('script[src*="assets/"]')||document.querySelector('link[href*="assets/"]')){const n=document.querySelector('link[href*="assets/"][href$=".css"]');return n?n.href:"/assets/components-_ANuRjC4.css"}return`/src/components/${e}`}connectedCallback(){if(!this.shadowRoot){this.attachShadow({mode:"open"});const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href",this.getComponentsPath("styles/navbar.css"));const t=this.getImagePath("ClearWay_logo.png"),n=this.getImagePath("menuBtn.png"),s=document.createElement("div");s.innerHTML=`
    ...
    `,e.appendChild(n),e.appendChild(a),this.setupBackButton(e)}setupBackButton(e){const t=e.querySelector("#backButton");t&&t.addEventListener("click",()=>{const n=window.location.pathname;n.includes("/pages/search.html")?document.referrer&&document.referrer.includes("main.html")?window.location.href="./main.html":document.referrer&&document.referrer.includes("index.html")?window.location.href="../index.html":window.history.back():n.includes("/pages/main.html")?window.location.href="../index.html":window.history.back()})}}customElements.define("app-navbar",k);customElements.define("app-footer",S);customElements.define("app-search-bar",E);customElements.define("app-page-header",B);
